...
/* config */
#	define _LCDML_DISP_cfg_cursor_deep				7		// save the last position of the cursor until layer xx
...
//# =======================
	...
	private:
		...
		uint8_t		parentID = 0;
		/* Name of my parent */
		char cbaneParent[_LCDML_DISP_cfg_max_rows][_LCDML_DISP_cfg_max_string_length];		
